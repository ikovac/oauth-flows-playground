...
const route = "/regular-web-app-implicit";
const REDIRECT_URI = new URL(`${route}/callback`, "http://localhost:3000").href;

const {
  AUTH0_DOMAIN,
  AUTH0_REGULAR_WEB_APP_CLIENT_ID,
  AUTH0_REGULAR_WEB_APP_CLIENT_SECRET,
  AUTH0_API_AUDIENCE,
} = process.env;
...
router.get("/login", (_req, res) => {
  ...
  url.searchParams.set("client_id", AUTH0_REGULAR_WEB_APP_CLIENT_ID);
